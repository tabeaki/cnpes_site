...
function useUpdateCreators(program) {
  const queryClient = useQueryClient();
  return useMutation(async creators => {
    requiredParamInvariant(program, "program is required");
...
export { ThirdwebProvider, ThirdwebSDKProvider, ThirdwebWrapperProvider, balanceQuery, claimConditionsQuery, dropTotalClaimedSupplyQuery, dropUnclaimedSupplyQuery, nftCreatorsQuery, nftGetAllQuery, nftRoyaltyQuery, programAccountTypeQuery, programMetadataQuery, programQuery, tokenBalanceQuery, tokenSupplyQuery, useAuth, useBalance, useBurnNFT, useClaimConditions, useClaimNFT, useCreators, useDropTotalClaimedSupply, useDropUnclaimedSupply, useLazyMint, useLogin, useLogout, useMintNFT, useMintNFTSupply, useMintToken, useNFTs, useProgram, useProgramAccountType, useProgramMetadata, useRoyaltySettings, useSDK, useSetClaimConditions, useTokenBalance, useTokenSupply, useTransferNFT, useTransferToken, useUpdateCreators, useUpdateRoyaltySettings, useUser };
